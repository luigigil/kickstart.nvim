...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- Shortcut for searching vault
      vim.keymap.set('n', '<leader>sv', function()
        local SECOND_BRAIN = vim.fn.getenv 'SECOND_BRAIN'
        builtin.find_files {
          find_command = {
            'rg',
            '--files',
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('gro', '<cmd>OrganizeImports<CR>', '[C]ode [O]rganize Imports')
      ...
      require('tokyonight').setup {
        ...
        styles = {
          comments = {
            ...
            -- fg = '#dcdcec', -- Comments foreground color
          },
